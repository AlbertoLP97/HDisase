#' Probabilidad de Enferemdades Cardio.
#'
#' @param age Ingresar edad del paciente "Female,Male"
#' @param sex Genero del paciente
#' @param thalach Presción sanginea del paciente
#'
#' @return
#' @export
#'
